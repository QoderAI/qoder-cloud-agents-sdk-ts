...
[qca-sdk](../../README.md) / [index](../README.md) / AuthenticationError

# Class: AuthenticationError

## Extends

- [`APIError`](APIError.md)\<`401`, `Headers`\>

## Constructors

### Constructor

> **new AuthenticationError**(`status`, `error`, `message?`, `headers?`, `response?`, `options?`): `AuthenticationError`
