...
[qca-sdk](../../README.md) / [index](../README.md) / BadRequestError

# Class: BadRequestError

## Extends

- [`APIError`](APIError.md)\<`400`, `Headers`\>

## Constructors

### Constructor

> **new BadRequestError**(`status`, `error`, `message?`, `headers?`, `response?`, `options?`): `BadRequestError`
