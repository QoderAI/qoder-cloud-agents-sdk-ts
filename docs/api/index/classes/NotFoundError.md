...
[qca-sdk](../../README.md) / [index](../README.md) / NotFoundError

# Class: NotFoundError

## Extends

- [`APIError`](APIError.md)\<`404`, `Headers`\>

## Constructors

### Constructor

> **new NotFoundError**(`status`, `error`, `message?`, `headers?`, `response?`, `options?`): `NotFoundError`
